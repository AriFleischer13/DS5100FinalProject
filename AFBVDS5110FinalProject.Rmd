...
#Swing State data brings data down to 230 rows 
...
Code to check the number of swing state counties in just the election dataset
``` {r}
#Swing state data from just the election dataset 
...
electionSwingState2 <- electionSwingState %>%
                       count(State)
electionSwingState2
```
